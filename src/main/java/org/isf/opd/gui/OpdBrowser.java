...
public class OpdBrowser extends ModalJFrame implements OpdEdit.SurgeryListener, SurgeryListener {
    ...
    private void applyFilter() {
        if (SEARCH_FILTER) {
            ...
            if (!progYearFilter.getText().isEmpty()) {
                opdCodeFilter.setText("");
                patientCodeFilter.setText("");
                model = new OpdBrowsingModel(Integer.parseInt(progYearFilter.getText()));
                TOTAL_OPDS = opdBrowserManager.countByProgYear(Integer.parseInt(progYearFilter.getText()));
            }

            if (!patientCodeFilter.getText().isEmpty()) {
                opdCodeFilter.setText("");
                progYearFilter.setText("");
                model = new OpdBrowsingModel(Integer.parseInt(patientCodeFilter.getText()));
                try {
                    TOTAL_OPDS = opdBrowserManager.countByPatientId(Integer.parseInt(patientCodeFilter.getText()));
    ...
    class OpdBrowsingModel extends DefaultTableModel {
        ...
        public OpdBrowsingModel(int code) {
            if (!patientCodeFilter.getText().isEmpty()) {
                try {
