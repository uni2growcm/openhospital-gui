...
public class HomeVisitReportDialog extends ModalJFrame {
    ...
    public HomeVisitReportDialog(JFrame parent) {
        super();
        setTitle(MessageBundle.getMessage("angal.homevisit.report.dialog.title"));
    ...
    private JPanel getDatePanel() {
        ...
        panel.setBorder(javax.swing.BorderFactory.createTitledBorder(
                MessageBundle.getMessage("angal.homevisit.report.period.border")));

        panel.add(new JLabel(MessageBundle.getMessage("angal.homevisit.report.datefrom.label")));
        dateFrom = new GoodDateChooser(LocalDate.now().minusMonths(1));
        panel.add(dateFrom);

        panel.add(new JLabel(MessageBundle.getMessage("angal.homevisit.report.dateto.label")));
    ...
    private JPanel getButtonPanel() {
        ...
        okButton.addActionListener(e -> {
            if (dateFrom.getDate().isAfter(dateTo.getDate())) {
                MessageDialog.error(this, "angal.homevisit.report.invaliddates.msg");
                return;
            }
        ...
        JButton cancelButton = new JButton(MessageBundle.getMessage("angal.homevisit.close.btn"));
