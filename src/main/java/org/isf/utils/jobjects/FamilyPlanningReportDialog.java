...
public class FamilyPlanningReportDialog extends ModalJFrame {
    ...
    public FamilyPlanningReportDialog(JFrame parent) {
        super();
        setTitle(MessageBundle.getMessage("angal.familyplanning.report.dialog.title"));
    ...
    private JPanel getDatePanel() {
        ...
        panel.setBorder(javax.swing.BorderFactory.createTitledBorder(
                MessageBundle.getMessage("angal.familyplanning.report.date.interval")));
