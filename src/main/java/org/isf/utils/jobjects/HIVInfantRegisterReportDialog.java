...
public class HIVInfantRegisterReportDialog extends ModalJFrame {
    ...
    public HIVInfantRegisterReportDialog(JFrame parent) {
        super();
        setTitle(MessageBundle.getMessage("angal.hiv.report.dialog.title"));
    ...
    private JPanel getDatePanel() {
        ...
        panel.setBorder(javax.swing.BorderFactory.createTitledBorder(
                MessageBundle.getMessage("angal.hiv.report.date.interval")));
