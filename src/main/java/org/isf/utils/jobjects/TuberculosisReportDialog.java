...
public class TuberculosisReportDialog extends ModalJFrame {
    ...
    public TuberculosisReportDialog(JFrame parent) {
        super();

        setTitle(MessageBundle.getMessage(
                "angal.tuberculosis.report.dialog.title"));
        ...
        panel.setBorder(
                javax.swing.BorderFactory.createTitledBorder(
                        MessageBundle.getMessage(
                                "angal.tuberculosis.report.date.interval")
                )
        );
    ...
    private JPanel getButtonPanel() {
        ...
        JButton okButton =
                new JButton(MessageBundle.getMessage("angal.common.ok.btn"));
        ...
        okButton.addActionListener(e -> {
            ...
            if (from == null || to == null) {
                MessageDialog.error(
                        this,
                        "angal.tuberculosis.report.date.required"
                );
                return;
            }
        ...
        JButton cancelButton =
                new JButton(MessageBundle.getMessage("angal.common.cancel.btn"));
