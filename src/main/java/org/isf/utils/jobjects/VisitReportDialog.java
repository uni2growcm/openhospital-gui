...
public class VisitReportDialog extends ModalJFrame {
    ...
    public VisitReportDialog(JFrame parent) {
        super();
        setTitle(MessageBundle.getMessage("angal.visit.report.dialog.title"));
    ...
    private JPanel getDatePanel() {
        ...
        panel.setBorder(javax.swing.BorderFactory.createTitledBorder(
                MessageBundle.getMessage("angal.visit.report.date.interval")));
